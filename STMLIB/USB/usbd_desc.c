...
#define USBD_VID                   0x0723
#define USBD_PID                   0xA380

#define USBD_LANGID_STRING         0x409
#define USBD_MANUFACTURER_STRING   "BlueSky"


#define USBD_PRODUCT_HS_STRING        "BlueSky FlightController"
#define USBD_SERIALNUMBER_HS_STRING   "00000000001A"
#define USBD_PRODUCT_FS_STRING        "BlueSky FlightController"
...
{
    USBD_USR_DeviceDescriptor,				//设备描述符
    USBD_USR_LangIDStrDescriptor, 			//语言标识符
    USBD_USR_ManufacturerStrDescriptor,	    //制造商描述符
    USBD_USR_ProductStrDescriptor,			//产品字符串描述符
    USBD_USR_SerialStrDescriptor,			//串口字符串描述符
    USBD_USR_ConfigStrDescriptor,			//配置字符串描述符
    USBD_USR_InterfaceStrDescriptor,		//接口字符串描述符
};
