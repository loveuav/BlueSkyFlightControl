...
#define DCFG_FRAME_INTERVAL_80                 0		//80%帧间隔
#define DCFG_FRAME_INTERVAL_85                 1		//85%帧间隔
#define DCFG_FRAME_INTERVAL_90                 2		//90%帧间隔
#define DCFG_FRAME_INTERVAL_95                 3		//95%帧间隔
