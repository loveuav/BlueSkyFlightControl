...
typedef struct __mavlink_global_position_int_t {
 ...
 int32_t alt; /*< Altitude (AMSL). Note that virtually all GPS modules provide both WGS84 and AMSL.*/
 ...
 * @param alt Altitude (AMSL). Note that virtually all GPS modules provide both WGS84 and AMSL.
 ...
 *
 * @return Altitude (AMSL). Note that virtually all GPS modules provide both WGS84 and AMSL.
 */
