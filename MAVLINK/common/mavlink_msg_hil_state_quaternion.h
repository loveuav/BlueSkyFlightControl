 ...
 * @param ind_airspeed Indicated airspeed
 ...
 *
 * @return Body frame roll / phi angular speed
 */
 ...
 *
 * @return Body frame pitch / theta angular speed
 */
 ...
 *
 * @return Body frame yaw / psi angular speed
 */
