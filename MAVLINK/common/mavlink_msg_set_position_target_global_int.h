...
typedef struct __mavlink_set_position_target_global_int_t {
 ...
 float alt; /*< Altitude (AMSL) if absolute or relative, above terrain if GLOBAL_TERRAIN_ALT_INT*/
 ...
 * @param alt Altitude (AMSL) if absolute or relative, above terrain if GLOBAL_TERRAIN_ALT_INT
 ...
 *
 * @return Altitude (AMSL) if absolute or relative, above terrain if GLOBAL_TERRAIN_ALT_INT
 */
